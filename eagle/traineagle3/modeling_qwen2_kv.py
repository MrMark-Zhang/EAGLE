...
class Qwen2Model(Qwen2PreTrainedModel):
    ...
    def forward(
        ...
        # decoder layers
        # [MODIFIED] Always collect hidden states at specific layers for EAGLE3 training
        all_hidden_states = ()
        ...
        for idx, decoder_layer in enumerate(self.layers):
            # [MODIFIED] Collect hidden states at layer 2, middle layer, and layer n-3 (like LLaMA version)
        ...
        # No need to add final hidden states here as we use early/middle layers
